...
__decorate([
    common_1.Get(),
    scope_decorator_1.Scopes('user-{userId}:read-session-*'),
...
], SessionController.prototype, "getAll", null);
__decorate([
    common_1.Get(':id'),
    scope_decorator_1.Scopes('user-{userId}:read-session-{id}'),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, common_1.Param('userId', common_1.ParseIntPipe)),
...
__decorate([
    common_1.Delete(':id'),
    scope_decorator_1.Scopes('user-{userId}:delete-session-{id}'),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, common_1.Param('userId', common_1.ParseIntPipe)),
    __param(1, common_1.Param('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
...
SessionController = __decorate([
    common_1.Controller('users/:userId/sessions'),
